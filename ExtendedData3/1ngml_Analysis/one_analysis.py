...
Extended Data 3 1ng/ml Analysis
'''
...
## IDs of samples as represented in the metadata table## IDs of samples as represented in the metadata table
an_run.sample_list = ['5073-2']
...
an_run.add_gene_list(markers= ['TUBB3','CHAT','NOS','VIP','S100B','CD117','SOX10','ANO1','SYN1','MPZ','PLP1'],
					 label='neuron_list')
...
an_run.set_filter_params(min_cells = 0, # Filter out cells 
						 ...
						 max_counts = 45000, # Filter out cells with more UMIs to catch a few remaining doublets
...
an_run.set_plot_params(exp_grouping = ['louvain', 'sampleName'], final_quality = True) 
